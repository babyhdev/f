...
calli.on("message", message => {
  if (message.content === prefix + "owner") {
    ...
    let embed = new Discord.MessageEmbed()
      .setColor(callicolor)
      .setImage(
        `https://media.discordapp.net/attachments/829751738717306920/835146132023279616/image0.png`
      )
      .setDescription(
        `
👑 OwnerCode 
...
(04・BABY#6666)
      ...
      .setThumbnail(
        `https://media.discordapp.net/attachments/829751738717306920/835145114519208017/image0.gif`
      );
...
const calliimgae = "";
const calliban = "";
const securitybots = "Anti Vandalism#6064";
const calliwarn = "";
const callidevelopers = "731952429238714378";
const calliowner = "731952429238714378";
///////////////////////////////////////////////////////////////////////////////
calli.on("ready", () => {
  let statuses = [
    "BaBy'm",
  ...
  setInterval(function() {
    ...
    calli.user.setActivity(STREAMING, {
      type: "PLAYING",
...
**Links**
[Support](https://discord.gg/3vS2YMT2UN) - [Invite](https://discord.com/api/oauth2/authorize?client_id=${calli.user.id}&permissions=8&scope=bot) - [Website](https://security-baby-1599.glitch.me/)
...
calli.on("message", message => {
  if (message.content === prefix + "rules") {
    ...
    let embed = new Discord.MessageEmbed()
      .setColor(callicolor)
      .setImage(`callilogo`)
      .setThumbnail(calli.user.avatarURL()).setDescription(`
**General Rules 
...
calli.on("message", async message => {
  if (message.content.startsWith(prefix + "invite")) {
    ...
    let help = new Discord.MessageEmbed().setColor(callicolor).setDescription(`
...
calli.on("message", message => {
  if (message.content === prefix + "servers") {
    ...
    let embed = new Discord.MessageEmbed()
      ...
      .addField(
        "Users",
        `${calli.guilds.cache.reduce((a, g) => a + g.memberCount, 0)} Users`,
        true
      )
      .setThumbnail(message.member.user.displayAvatarURL({ dynamic: true }));
    message.channel.send({ embed });
...
calli.on("message", message => {
  if (message.content === prefix + "settings") {
    ...
    let embed = new Discord.MessageEmbed()
      .setThumbnail(message.member.user.displayAvatarURL({ dynamic: true }))
      .setColor(callicolor)
      .setAuthor("Security Settings", "").setDescription(`
...
calli.on("message", message => {
  if (message.content.startsWith(prefix + "anti bot on")) {
    ...
    let embed = new Discord.MessageEmbed().setColor(callicolor).setDescription(`
